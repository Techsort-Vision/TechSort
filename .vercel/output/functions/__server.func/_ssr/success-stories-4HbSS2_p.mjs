...
import { GlowButton } from "./router-DXvb7jPE.mjs";
...
function Success() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { breadcrumbs: [{
      label: "Our Values"
    }], eyebrow: "What drives us", title: "A company built on trust and care", subtitle: "We are creating TechSort around the belief that great digital work should feel thoughtful, collaborative, and lasting." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong gradient-border rounded-3xl p-8 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-semibold", children: "Our work is grounded in clarity and care." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-8 text-muted-foreground", children: "We keep our process simple and transparent, communicate clearly, and aim for outcomes that feel as strong as they look. Whether we are shaping a brand experience, a product interface, or a launch strategy, we bring the same calm focus to every detail." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GlowButton, { to: "/contact", children: "Let’s build something meaningful" }) })
    ] }) }) })
  ] });
}
export {
