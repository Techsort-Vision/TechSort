...
function CaseStudies() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { breadcrumbs: [{
      label: "Our Approach"
    }], eyebrow: "What we stand for", title: "Thoughtful strategy, polished execution", subtitle: "We focus on building digital experiences that feel clear, intentional, and ready to grow with your ambition." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong gradient-border rounded-3xl p-8 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-semibold", children: "We believe the best work starts with listening." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-8 text-muted-foreground", children: "Every engagement begins with understanding your goals, users, and constraints so the final experience feels thoughtful rather than rushed. Our work is shaped by clarity, craft, and the kind of calm execution that builds trust over time." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GlowButton, { to: "/contact", children: "Start a conversation" }) })
    ] }) }) })
  ] });
}
export {
