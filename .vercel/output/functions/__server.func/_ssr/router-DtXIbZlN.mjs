...
import { M as Menu, X, a as Mail, P as Phone, b as MapPin, C as Clock, T as Twitter, L as Linkedin, G as Github, I as Instagram, D as Dribbble, S as Sparkles, c as MessageCircle } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-E1l8_cGp.css";
        ...
        motion.aside,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-t border-white/[0.06] grid gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: SITE.phone })
            ] })
          ]
        }
      )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 grid gap-2 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:${SITE.phone}`, className: "flex items-center gap-2 hover:text-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "size-4 text-sky" }),
              SITE.phone
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex gap-2", children: [{ Icon: Twitter, href: SITE.socials.twitter }, { Icon: Linkedin, href: SITE.socials.linkedin }, { Icon: Github, href: SITE.socials.github }, { Icon: Instagram, href: SITE.socials.instagram }, { Icon: Dribbble, href: SITE.socials.dribbble }].map(({ Icon, href }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, target: "_blank", rel: "noreferrer", className: "size-9 rounded-lg glass grid place-items-center hover:glow-sm hover:scale-110 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-4" }) }, i)) })
        ] }),
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            !done ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-5 grid gap-3", onSubmit: (e) => {
              e.preventDefault();
              setDone(true);
              setTimeout(close, 1200);
            }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", required: true, placeholder: "you@company.com", className: "rounded-lg bg-white/[0.04] border border-white/10 px-4 py-3 text-sm outline-none focus:border-primary/60 transition-colors" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded-lg bg-primary text-primary-foreground font-semibold py-3 text-sm hover:bg-primary/90 transition-colors", children: "Subscribe" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 rounded-lg bg-white/[0.04] border border-white/10 p-4 text-sm text-center text-primary", children: "✓ You're in. Check your inbox." }),
...
const $$splitComponentImporter$h = () => import("./technologies-D2fbjfVl.mjs");
...
const $$splitComponentImporter$g = () => import("./team-By5pk9rR.mjs");
...
const $$splitComponentImporter$f = () => import("./support-C49ec-R2.mjs");
...
const $$splitComponentImporter$e = () => import("./success-stories-D1DPggUw.mjs");
...
const $$splitComponentImporter$d = () => import("./services-B87Ta5M6.mjs");
...
const $$splitComponentImporter$c = () => import("./request-quote-BWdCmD54.mjs");
...
const $$splitComponentImporter$b = () => import("./privacy-AJn40Cx2.mjs");
...
const $$splitComponentImporter$a = () => import("./pricing-CLHU6Ho0.mjs");
...
const $$splitComponentImporter$9 = () => import("./portfolio-DB9JcFy5.mjs");
...
const $$splitComponentImporter$8 = () => import("./faq-DJrptOj6.mjs");
...
const $$splitComponentImporter$7 = () => import("./contact-C-uYynU2.mjs");
...
const $$splitComponentImporter$6 = () => import("./coming-soon-D7u8_wk3.mjs");
...
const $$splitComponentImporter$5 = () => import("./case-studies-BpPbUVFS.mjs");
...
const $$splitComponentImporter$4 = () => import("./careers-CKHQ6oX7.mjs");
...
const $$splitComponentImporter$3 = () => import("./blog-DhXqB9wj.mjs");
...
const $$splitComponentImporter$2 = () => import("./about-C8YhzSSK.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-Bw3dUUvv.mjs");
...
const $$splitComponentImporter = () => import("./services._slug-BhV01ehT.mjs");
