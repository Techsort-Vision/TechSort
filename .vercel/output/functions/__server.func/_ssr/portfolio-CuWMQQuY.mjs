...
function Portfolio() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    }], eyebrow: "Our approach", title: "A studio built around thoughtful digital work", subtitle: "We are a new company focused on strategy, design, and dependable delivery for founders and growing brands." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-4 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong gradient-border rounded-3xl p-8 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-semibold", children: "We are still shaping our first public body of work." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-8 text-muted-foreground", children: "Rather than showcasing completed client work, this space now introduces who we are, what we believe in, and how we approach digital products with clarity and care." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GlowButton, { to: "/about", children: "Learn about us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GlowButton, { to: "/contact", variant: "ghost", children: "Start a conversation" })
      ] })
    ] }) }) })
  ] });
}
